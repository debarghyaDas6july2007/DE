...
function draw() {
 ...
 if(gameState === 1){
    ...
    if (bulletGroup.collide( enemySpaceGroup2)){
     ...
     if(enemySpaceGroup1.collide(invisibleWall)){
       life = life-1;
       enemySpaceGroup1.destroyEach();
     }

     if(enemySpaceGroup2.collide(invisibleWall)){
      life = life-1;
      enemySpaceGroup2.destroyEach();
    }

    if(enemySpaceGroup3.collide(invisibleWall)){
      life = life-1;
      enemySpaceGroup3.destroyEach();
    }

    if(enemySpaceGroup4.collide(invisibleWall)){
      life = life-1;
      enemySpaceGroup4.destroyEach();
    }

    if(enemySpaceGroup5.collide(invisibleWall)){
      life = life-1;
